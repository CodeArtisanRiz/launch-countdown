...
let inputDateTime;
let inputTitle="WE'RE LAUNCHING SOON";
let inputDescription="";
let inputCreditText="";
let inputCreditUrl="";
let inputCreditUrlName="";
...
passedDateTime.forEach(function(script) {
    ...
    let inputDescriptionAttr = script.getAttribute('description');
    if (typeof inputDescription !== '') {
        inputDescription = inputDescriptionAttr;
    }

    let inputCreditTextAttr = script.getAttribute('credit-text');
    if (typeof inputCreditText !== '') {
        inputCreditText = inputCreditTextAttr;
    }
    let inputCreditUrlAttr = script.getAttribute('credit-url');
    if (typeof inputCreditUrl !== '') {
        inputCreditUrl = inputCreditUrlAttr;
    }
    let inputCreditUrlNameAttr = script.getAttribute('credit-url-name');
    if (typeof inputCreditUrlName !== '') {
        inputCreditUrlName = inputCreditUrlNameAttr;
    }
